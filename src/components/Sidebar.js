import {
    AddCircleOutline, DocumentScanner, KeyboardArrowDown, KeyboardArrowUp,
    KeyboardDoubleArrowLeft, KeyboardDoubleArrowRight, Logout, Search, Settings
} from '@mui/icons-material';
import { Avatar, Box, Collapse, Divider, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Typography } from '@mui/material';
    ...
    return (
        ...
        >
                            ...
                            >
                                ...
                                {openSideBar && (
                                    <>
                                        ...
                                        >
                                            {expandedIndex === index ? <KeyboardArrowUp fontSize="inherit" /> : <KeyboardArrowDown fontSize="inherit" />}
                                        </ListItemIcon>
                                    </>
                                )}
                            </ListItem>
                            ...
                            <Collapse in={openSideBar && expandedIndex === index} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding>
                                    {screen.subtitle.map((subItem, subIndex) => (
                                        <ListItemButton key={subIndex} sx={{ borderRadius: '8px', '&:hover': { backgroundColor: primary[50] } }} disableTouchRipple>
                                            <ListItemText
                                                primary={subItem}
                                                sx={{
                                                    '& .MuiListItemText-primary': {
            ...
            <List>
                ...
                >
                    <ListItemIcon sx={{ color: activeMenu === MENUS.SETTINGS ? primary[500] : dark[500], justifyContent: 'center' }}>
                        <Settings />
                    </ListItemIcon>
                    {openSideBar && (
                        <ListItemText
                ...
                <ListItem
                    ...
                    onClick={() => toggleMenu(MENUS.LOGOUT)}
                >
