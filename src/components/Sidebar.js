		...
		>
			...
			>
				{openSideBar && (
					<Typography
						variant="h6"
						sx={{ flexGrow: 1, ml: 2, color: dark[700] }}
					>
						.natonity
					</Typography>
				)}
						...
						<React.Fragment key={index}>
							<ListItem
								...
								sx={{
									...
									backgroundColor:
										expandedIndex === index ? primary[50] : white[50],
								}}
							>
								<ListItemIcon
									sx={{
										...
										<ListItemText
											...
											sx={{
												"& .MuiListItemText-primary": {
													fontSize: "16px",
													color:
														expandedIndex === index ? primary[500] : dark[500],
												},
											}}
										/>
										<ListItemIcon
							...
							<Collapse
								in={openSideBar && expandedIndex === index}
								timeout="auto"
								unmountOnExit
							>
			...
			<List>
				<ListItem
					...
					sx={{
						...commonListItemStyles,
						backgroundColor:
							activeMenu === MENUS.SETTINGS ? primary[50] : white[50],
					}}
						...
						<ListItemText
							...
							sx={{
								"& .MuiListItemText-primary": {
									fontSize: "16px",
									color:
										activeMenu === MENUS.SETTINGS ? primary[500] : dark[500],
								},
							}}
						/>
					)}
				...
				<ListItem
					...
					sx={{
						...commonListItemStyles,
						backgroundColor:
							activeMenu === MENUS.LOGOUT ? primary[50] : white[50],
					}}
				...
				<ListItem
					...
					sx={{
						...commonListItemStyles,
						backgroundColor:
							activeMenu === MENUS.PROFILE ? primary[50] : white[50],
					}}
